...
namespace MediaBrowser.WindowsPhone
{
    ...
    {
        public static WindowsPhoneProfile GetWindowsPhoneProfile(float maxBitrate = 2000000, bool isHls = false)
        {
            ...
            profile.CodecProfiles = new[]
            {
                ...
                //            Condition = ProfileConditionType.LessThanEqual,
                //            Property = ProfileConditionValue.Width,
                //            Value = "1000" //screenInfo.Bounds.Height.ToString(CultureInfo.InvariantCulture)
                //        },
                //        new ProfileCondition
                //        {
                //            Condition = ProfileConditionType.LessThanEqual,
                //            Property = ProfileConditionValue.Height,
                //            Value = "1000" //screenInfo.Bounds.Width.ToString(CultureInfo.InvariantCulture)
                //        },
                //        new ProfileCondition
                //        {
                //            Condition = ProfileConditionType.LessThanEqual,
