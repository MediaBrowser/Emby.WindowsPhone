...
namespace MediaBrowser.WindowsPhone.Converters
{
    public class FavouritesConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (value == null)
            {
                if(textOrIcon)return favouriteType.Contains("full") ? AppResources.LabelAddToFavourites : AppResources.LabelAdd;
            ...
            if (textOrIcon)
            {
                ...
                {
                    return isFavourite ? AppResources.RemoveFromFavouritesFull : AppResources.LabelAddToFavourites;
                }

                return isFavourite ? AppResources.LabelRemove : AppResources.LabelAdd;
            }
